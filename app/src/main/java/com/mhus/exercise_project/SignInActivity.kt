...
import com.mhus.exercise_project.databinding.ActivitySignInBinding
...
import net.mhus.fiveinone.exerciseproject.*
...
class SignInActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnRegister = findViewById<TextView>(R.id.tvCreateNewAccount)
        ...
        val createNewAccount = findViewById<TextView>(R.id.tvCreateNewAccount)
