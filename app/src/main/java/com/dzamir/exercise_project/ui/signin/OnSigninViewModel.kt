...
import com.dzamir.exercise_project.data.api.ErrorResponse
import com.dzamir.exercise_project.data.api.auth.SignInRequest
...
class OnSigninViewModel(): ViewModel() {
