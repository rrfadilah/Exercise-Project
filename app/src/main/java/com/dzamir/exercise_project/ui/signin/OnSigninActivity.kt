package com.dzamir.exercise_project.ui.signin
...
import com.dzamir.exercise_project.CustomDialogFragment
import com.dzamir.exercise_project.R
import com.dzamir.exercise_project.database.MyDoctorDatabase
import com.dzamir.exercise_project.databinding.ActivityOnSigninBinding
import com.dzamir.exercise_project.home.Home_activity
import com.google.android.material.snackbar.Snackbar

class OnSigninActivity : AppCompatActivity() {
    lateinit var binding: ActivityOnSigninBinding
    private val viewModel: OnSigninViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityOnSigninBinding.inflate(layoutInflater)
    ...
    fun dialogCustomLayout() {
        val view = LayoutInflater.from(this).inflate(R.layout.fragment_custom_dialog, null, false)
        val dialog = AlertDialog.Builder(this)
        dialog.setView(view)
        dialog.create().show()
    }
